  ...
  return (
    <TableHead>
      <TableRow sx={{ background: '#EFEFEF' }}>
        ...
        <TableCell align="right" onClick={() => sortRows('card', dispatch, sortPacks)}>
          Cards
        ...
        <TableCell align="right" onClick={() => sortRows('updated', dispatch, sortPacks)}>
          Last Updated
        ...
        <TableCell align="right" onClick={() => sortRows('user_name', dispatch, sortPacks)}>
          Created by
